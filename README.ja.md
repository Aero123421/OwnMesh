...
OwnMesh はセルフホスト型のオープンソース capability runtime です。ChatGPT
などの MCP クライアントが、ユーザー自身の Cloudflare アカウントに置いた
コントロールプレーン経由で、所有する Windows / macOS / Linux PC を利用できます。
...
**v1.2.0-beta.12** — Apache-2.0 モノレポ（Rust + Cloudflare Worker）。
