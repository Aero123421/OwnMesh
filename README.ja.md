...
**v1.2.6 正式安定版** — Apache-2.0 モノレポ（Rust + Cloudflare Worker）。
...
notarization、MSI/NSIS、macOS native package は v1.2.6 の対象外です。
...
- [v1.2.6 release notes](./docs/RELEASE_NOTES_v1.2.6.md)
