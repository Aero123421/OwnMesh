...
**v1.2.13 正式安定版** — Apache-2.0 モノレポ（Rust + Cloudflare Worker）。
...
notarization、MSI/NSIS、macOS native package は v1.2.13 の対象外です。
...
- [v1.2.13 release notes](./docs/RELEASE_NOTES_v1.2.13.md)
