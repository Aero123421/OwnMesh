...
**v1.2.14 正式安定版** — Apache-2.0 モノレポ（Rust + Cloudflare Worker）。
...
notarization、MSI/NSIS、macOS native package は v1.2.14 の対象外です。
...
- [v1.2.14 release notes](./docs/RELEASE_NOTES_v1.2.14.md)
